...
Sortable.prototype.init = function() {
    ...
    self.$sortable.dragaware($.extend({}, self.options, {
        ...
        dragstart: function(evt) {
            ...
            const clone_children = $clone.children();
            $node.children().each((i, el) => {
                clone_children.eq(i).width($(el).width());
            });
...
PositionHelper.prototype.absolutize = function(pos) {
    ...
    return {top: this.origin.top + pos.dY, left: this.origin.left};
    // NOTE: uncomment this to enable X-Y drag
